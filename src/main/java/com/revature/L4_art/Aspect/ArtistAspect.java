...
public class ArtistAspect {
     ...
     * that is applied before any method in ArtistService executes. The expression provided to the Before annotation
     ...
     */
    @Before("execution(* com.revature.L4_art.Service.ArtistService.*(..))")
     ...
     * it defines where the Advice should be applied. In this case, the println statement is Advice
     * that is applied after any method in ArtistService executes. The expression provided to the After annotation
     * is a pointcut expression, which defines which methods the Advice is applied to. More on Advice annotations and
     * Pointcut expressions below.
     *
     * @param joinPoint Object representing the position in the code where the Advice has been applied.
     */
    @After("execution(* com.revature.L4_art.Service.ArtistService.*(..))")
